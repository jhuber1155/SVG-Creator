...
class triangle extends shapes{
    ...
    this.render(logo) = function () {
        ...
        text text-anchor="middle" x="147" y="130"<tspan fill = ${textColor}>${letter}</tspan></text>}`)
...
class circle extends shapes{
    constructor(x, y, text, textColor, chosenShape, setColor){
        ...
        this.render(logo) = function () {
            ...
            text text-anchor="middle" x="150" y="105" <tspan fill = ${textColor}>${letter}</tspan></text>`)
        } 
            }}
}
...
class square extends shapes{
    constructor(x, y, text, textColor, chosenShape, setColor){
        ...
        this.render(logo) = function () {
            ...
            return (`<rect x="90" y="40" width="120" height="120" fill= ${setColor}/>'text text-anchor="middle" x="150" y="105" <tspan fill = ${textColor}>${letter}</tspan></text>`)
        }
            }}
}
